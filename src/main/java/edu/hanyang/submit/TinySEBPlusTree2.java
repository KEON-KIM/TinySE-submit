...
////			Node2 node;
////			if(meta_buffer[0] == 2) {
////				node = new Node2(tree_buffer, this.blocksize, meta_buffer, true);
////				node.set_node_size();
////				System.out.printf("offset(%d) node(%d) : ", i, node.node_size);
////				this.printarray(node.leaf_to_tree_buffer());
////			} else {
////				node = new Node2(tree_buffer, this.blocksize, meta_buffer);
////				node.set_node_size();
////				System.out.printf("offset(%d) node(%d) : ", i, node.node_size);
...
//			
//			this.offset++;
//			this.cur = new Node2(this.blocksize, 0, this.offset); //non leaf 
//			this.cur.vals.add(this.offset - 2);
//			this.cur.insert(this.piv[0], this.piv[1]);
//			this.height++;
//			this.root = this.cur.copyNode2();
//			
//			this.writeToTree(this.cur.to_tree_buffer());
//			this.writeToMeta(this.cur.to_meta_buffer());
////			this.printallnode();
...
//			return;
//		} else {
//			this.cur = new Node2(this.blocksize, 2, this.offset); // leaf
//			this.cur.leaf_insert(key, val);
//
//			this.writeToTree(this.cur.leaf_to_tree_buffer());
//			this.writeToMeta(this.cur.to_meta_buffer());
...
//
//
//	public void splitLeafNode2() throws IOException {
...
//		
//		this.offset++;
//		this.cur = new Node2(tmp, this.blocksize, 2, this.offset, true); //leaf node
//		this.writeToTree(this.cur.leaf_to_tree_buffer());
//		this.writeToMeta(this.cur.to_meta_buffer());
...
//	}
//
//	public void splitNonLeafNode2() throws IOException{
//		
//		int fanout = this.cur.max_num / 2 + 1;
//		/* cur node 작업
//		 * leaf node이므로 metafile 작업 x*/
...
//		
//		this.offset++;
//		this.cur = new Node2(buffer, this.blocksize, 1, this.offset);
//
//		this.writeToTree(this.cur.to_tree_buffer());
//		this.writeToMeta(this.cur.to_meta_buffer());
//	}
//	
//	
//	public void splitRootNode2() throws IOException {
//		this.cur.status = 1;
//		
//		int fanout = this.cur.max_num / 2 + 1;
//		/* cur node 작업
...
//		
//		this.offset++;
//		this.cur = new Node2(this.blocksize, 0, this.offset);
...
//		this.root = new Node2(tree_buffer, this.blocksize, meta_buffer);
//		this.cur = this.root;
//		search_leaf_node_(key);
//		int result = this.cur.get_value(key);
//		this.cur = null;
...
//		if (meta_buffer[0] == 1) {
//			this.cur = new Node2(tree_buffer, this.blocksize, meta_buffer);
//		} else {
//			this.cur = new Node2(tree_buffer, this.blocksize, meta_buffer, true);
//		}
//		meta_buffer = null;
//		tree_buffer = null;
//		
...
//		if (meta_buffer[0] == 1) {
//			this.cur = new Node2(tree_buffer, this.blocksize, meta_buffer);
//			this.cache.add(new Node2(tree_buffer, this.blocksize, meta_buffer));
//			return;
//		}
//		this.cur = new Node2(tree_buffer, this.blocksize, meta_buffer, true);
//		this.cache.add(new Node2(tree_buffer, this.blocksize, meta_buffer, true));
//		
//		
//	}
//
...
////							new FileInputStream(testfile), blocksize)
////							);
...
//	 * 마지막에한번 할지 결정해야함*/
//	/* file에서 가져와서 노드 생성할때*/
//	Node2(int[] tree_buffer, int blocksize, int status, int offset, boolean leaf) {
//		this.max_num = (blocksize / Integer.BYTES) - 2;
//		this.blocksize = blocksize;
//		this.node = new int[(blocksize / Integer.BYTES) - 2];
//		
//		this.status = status;
//		this.offset = offset;
//	}
//	
//	Node2(int[] tree_buffer, int blocksize, int status, int offset) {
//		this.max_num = (blocksize / Integer.BYTES) - 1;
//		this.blocksize = blocksize;
//		this.node = tree_buffer;
//		this.status = status;
//		this.offset = offset;
//	}
//	
//	/* 새로운 leaf 노드를 생성할 때*/
//	Node2(int blocksize, int status, int offset, boolean leaf) {
//		this.max_num = (blocksize / Integer.BYTES) - 2;
//		this.blocksize = blocksize;
//		this.node = new int[max_num];
//		
//		this.status = status;
//		this.offset = offset;
//	}
//	
//	Node2(int blocksize, int status, int offset) {
//		this.max_num = (blocksize / Integer.BYTES) - 1;
//		this.blocksize = blocksize;
//		this.node = new int[max_num];
//		this.status = status;
...
//	
//	/*leaf 면 true*/
//	Node2(int[] tree_buffer, int blocksize, int[] meta_buffer, boolean leaf) {
//		this.max_num = (blocksize / Integer.BYTES) - 2 ;
//		this.blocksize = blocksize;
//		int[] 
...
//	
//	/*non leaf 일 경우*/
//	Node2(int[] tree_buffer, int blocksize, int[] meta_buffer) {
//		this.max_num = (blocksize / Integer.BYTES) / 2;
//		
...
//		
//	}
//	public Node2 copyNode2() {
//		int[] tree_buffer = this.to_tree_buffer();
//		int[] meta_buffer = this.to_meta_buffer();
//		return new Node2(tree_buffer, this.blocksize, meta_buffer);
//	}
//	
//}
